...
.hero h1{margin:0;max-width:100%;font-size:clamp(1.35rem,2.1vw,2rem);line-height:1.22;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;word-break:normal}.hero p{margin:.55rem 0 0;color:#e4f7fa}
...
if page == "Executive Command Center":
    ...
    category = st.selectbox(
        "Governance category",
        [f"High risk ({len(high)})", f"Evidence needed ({len(weak)})", f"Overdue governance ({len(overdue)})"],
