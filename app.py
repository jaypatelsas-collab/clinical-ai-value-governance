...
.kpi-grid{display:grid;grid-template-columns:repeat(4,minmax(170px,1fr));gap:12px;margin:8px 0 12px}.kpi-card{position:relative;background:#fff;border:1px solid var(--line);border-radius:13px;padding:15px 16px 14px;box-shadow:0 5px 16px rgba(15,23,42,.055);min-height:116px}.kpi-card:before{content:"";position:absolute;left:0;top:0;right:0;height:4px;border-radius:13px 13px 0 0;background:linear-gradient(90deg,#00A6A6,#2563EB)}.kpi-label{font-size:.78rem;font-weight:700;color:#526176;text-transform:uppercase;letter-spacing:.035em}.kpi-value{font-size:1.72rem;font-weight:800;color:var(--navy);margin-top:10px;line-height:1}.kpi-note{font-size:.75rem;color:#718096;margin-top:9px}
