...
/* Sidebar */
[data-testid="stSidebar"]{background:var(--mulberry);border-right:1px solid #6E0044}
...
[data-testid="stSidebar"] [role="radiogroup"] label{padding:.38rem .48rem;border-radius:.5rem;color:var(--white)!important}
...
.hero{padding:18px 24px;border-radius:12px;background:var(--mulberry);color:var(--white);margin-bottom:14px;overflow:visible;box-shadow:0 7px 20px rgba(131,0,81,.18)}
...
.hero p{margin:.48rem 0 0;color:var(--white)!important;opacity:.94}
.badge{display:none!important}

/* Cards and section text */
.kpi-grid{display:grid;grid-template-columns:repeat(4,minmax(170px,1fr));gap:12px;margin:8px 0 12px}
.kpi-card{position:relative;background:var(--white);border:1px solid var(--line);border-radius:12px;padding:15px 16px 14px;box-shadow:0 4px 14px rgba(63,68,68,.07);min-height:116px}
...
.section-card{border:1px solid var(--line);border-radius:12px;padding:15px 17px;background:var(--white);margin-top:8px;box-shadow:0 4px 12px rgba(63,68,68,.055)}
...
.action{border:1px solid var(--line);border-left:5px solid var(--mulberry);border-radius:10px;padding:10px 13px;margin:6px 0;background:var(--white)}
